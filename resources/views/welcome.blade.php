            ...
            <div class="d-md-flex justify-content-between">
                ...
                <div class="d-flex align-items-center py-2">
                    <div class="shadow rounded-8">
                        <img class="" src="{{ asset('images/logos/icon.png') }}" alt="MyADC" style="width: 80px; height: 80px; border-radius: 50%;">
        ...
        <div class="container">
            <div class="d-md-flex justify-content-center small mt-3">
                <div class="text-muted">&copy;
                    ...
                    </script>. Developed and supported by <a href="https://github.com/youseefkhaled"
                        target="blank">Yousef Khaled</a>
                </div>
                <div class="ms-1">
                    &middot;
